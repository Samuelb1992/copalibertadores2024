...
logo: images/copa-libertadores-logo.png
...
<!-- ```{ojs} -->
<!-- //| output: false -->
<!-- // Fija el filtro en la tabla ('tbl') , buscando en la columna (Home_Team) el valor seleccionado en 'Equipos' -->
<!-- Reactable.setFilter('tbl', 'Home_Team', Equipos) -->
<!-- ``` -->
